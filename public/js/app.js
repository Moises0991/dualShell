...
var appear_notification = new Audio('/sound/notifications/appear_notification.mp3');
  ...
  methods: {
    ...
    register: function register() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/sanctum/csrf-cookie').then(function (response) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/register', credentials).then(function (response) {
          // cleaning fields
          _this.registerUser.name = '';
          _this.registerUser.email = '';
          _this.registerUser.password = '';
          _this.registerUser.confirmPass = '';

          _this.notify('register', response.data.message, response.data.success);
    ...
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/sanctum/csrf-cookie').then(function (response) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/login', credentials).then(function (response) {
          // cleaning fields
          _this2.loginUser.email = '';
          _this2.loginUser.password = '';

          _this2.notify('login', response.data.message, response.data.success);
        })["catch"](function (error) {
          console.error(error);
        });
      }); // this.$router.push({name: 'register'});
    },
    notify: function notify(proceed, message, auth) {
      // create notification
      var btn = document.getElementById("".concat(proceed, "-trigger")); // var responseMessage = 'Contraseñas no coinciden';

      classie.add(btn, 'active');
      setTimeout(function () {
        classie.remove(btn, 'active'); // create the notification
  ...
  return _c("div", { staticClass: "container", attrs: { id: "container" } }, [
      ...
      _c(
        ...
        [
          ...
          _c("input", {
            ...
            domProps: { value: _vm.registerUser.name },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.registerUser, "name", $event.target.value)
              },
            },
          }),
          _vm._v(" "),
          _c("input", {
            ...
            domProps: { value: _vm.registerUser.email },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.registerUser, "email", $event.target.value)
              },
            },
          }),
          _vm._v(" "),
          _c("input", {
            ...
            domProps: { value: _vm.registerUser.password },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.registerUser, "password", $event.target.value)
              },
            },
          }),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.registerUser.confirmPass,
                expression: "registerUser.confirmPass",
              },
            ],
            attrs: {
              type: "password",
            ...
            domProps: { value: _vm.registerUser.confirmPass },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.registerUser, "confirmPass", $event.target.value)
              },
            },
          }),
          _vm._v(" "),
          _c(
            ...
            {
              staticClass: "gap",
              attrs: { type: "submit", id: "register-trigger" },
            },
            [_vm._v("Registrarse")]
          ),
        ]
    ...
    _c("div", { staticClass: "form-container sign-in-container" }, [
      _c(
        ...
        [
          _c("h1", [_vm._v("Iniciar Sesion")]),
          _vm._v(" "),
          _vm._m(0),
          _vm._v(" "),
          _c("span", [_vm._v("o usa tu cuenta")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
          ...
          _c(
            "button",
            {
              ...
              attrs: { type: "submit", id: "login-trigger" },
            },
            [_vm._v("Iniciar")]
          ),
        ]
    ...
    _c("div", { staticClass: "overlay-container" }, [
      _c("div", { staticClass: "overlay" }, [
            ...
            "button",
            {
              ...
              on: {
                click: function ($event) {
                  return _vm.focus("signIn")
                },
              },
            },
            [_vm._v("Inciar Sesion")]
          ),
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "overlay-panel overlay-right" }, [
          ...
          _c("p", [
            _vm._v(
              "Si aun no tiene una cuenta, ingrese sus datos y comienze su historia"
            ),
          ]),
          _vm._v(" "),
          _c(
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", { staticClass: "social-container" }, [
      _c(
        "a",
        { staticClass: "social", attrs: { href: "/api/login-facebook" } },
        [_c("i", { staticClass: "fab fa-facebook-f" })]
      ),
      _vm._v(" "),
      _c("a", { staticClass: "social", attrs: { href: "/api/login-google" } }, [
        _c("i", { staticClass: "fab fa-google-plus-g" }),
      ]),
      _vm._v(" "),
      _c(
        "a",
        { staticClass: "social", attrs: { href: "/api/login-linkedin" } },
